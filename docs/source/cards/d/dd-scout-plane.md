...
Source: [https://edisonformat.net/card?name=D.D.%20Scout%20Plane](https://edisonformat.net/card?name=D.D.%20Scout%20Plane)
...
*   If you don't have a vacant Monster Card Zone when D. D. Scout Plane would be Special Summoned, D. D. Scout Plane is destroyed and sent to the GY.
*   D. D. Scout Plane's effect activates whether it is removed from your hand, Deck, GY, or the field.
...
*   If D. D. Scout Plane is removed from play and then returned to the GY with Miracle Dig the same turn, its effect is reset and it remains in the GY and is not Special Summoned.
