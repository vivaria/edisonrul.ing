...
Source: [https://edisonformat.net/card?name=Mystic%20Swordsman%20LV](https://edisonformat.net/card?name=Mystic%20Swordsman%20LV)

### Edison-Accurate PSCT

> ① At the start of the Damage Step, if this card is attacking a Set monster: Destroy that Set monster.
> ② During the End Phase, if this card destroyed a monster by battle this turn: You can send this face-up card to the GY; Special Summon 1 "Mystic Swordsman LV4" from your hand/Deck.
