...
Source: [https://edisonformat.net/card?name=Magical%20Thorn](https://edisonformat.net/card?name=Magical%20Thorn)

### Edison-Accurate PSCT

> ① If a card(s) is discarded from your opponent's hand and sent to the GY, inflict 500 damage to them for each.
