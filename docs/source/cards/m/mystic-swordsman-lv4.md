...
Source: [https://edisonformat.net/card?name=Mystic%20Swordsman%20LV4](https://edisonformat.net/card?name=Mystic%20Swordsman%20LV4)
...
*   The Normal Summon of this card is always considered a Set. If Light of Intervention is active, you can't Normal Summon Mystic Swordsman LV4 because it can only be Normal Summoned face-down, which Light of Intervention makes impossible to do.
*   If Mystic Swordsman LV4 attacks a face-down Defense Position monster, you destroy the monster with Mystic Swordsman LV4’s effect before flipping the monster face-up. Effects like D. D. Warrior Lady can't activate.
