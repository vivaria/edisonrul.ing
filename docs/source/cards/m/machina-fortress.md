...
The Ⓢ:
*   This card can discard itself as part of the cost.

The ①:
*   Your question is probably answered here: https://edisonformat.net/rules/compendium/Substep-Triggers

The ②:
*   If the effect targeting this card resolves negated, this still applies.
*   If the activation of the effect targeting this card is negated, this does not apply.
*   This applies directly before resolving the opponent's monster effect.
*   This happens during a chain, so nothing can be chained to it.
*   This is not an activated effect, so nothing can be chained to it.
