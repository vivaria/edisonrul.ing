...
Source: [https://edisonformat.net/card?name=Power%20Bond](https://edisonformat.net/card?name=Power%20Bond)
...
*   Even if the Fusion Monster is removed from the field or flipped face-down, you can't negate the effect of “Power Bond” and the player will still take damage equal to the original ATK.
...
*   If “Non-Spellcasting Area” is active and “Power Bond” is used to Special Summon a Fusion Monster that has no effect, the Fusion Monster won't gain the ATK bonus from “Power Bond”, but the controller will still take damage for “Power Bond” (because the player is not a non-Effect Monster Card).
