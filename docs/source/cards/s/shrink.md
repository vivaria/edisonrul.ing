...
Source: [https://edisonformat.net/card?name=Shrink](https://edisonformat.net/card?name=Shrink)

### Edison-Accurate PSCT

> Target 1 face-up monster on the field; its original ATK becomes half of its printed ATK until the End Phase.

### Card Rulings

*   Shrink sets the ATK equal to half the target's original ATK, after which other modifiers are applied. Applying a second "Shrink" will not halve the ATK again.

*   VS "Card Trooper"/"Exarion Universe" (ATK/DEF increase/decrease applying only to itself):
Half its original ATK, then reapply the ATK/DEF increase/decrease from its effect.
(The UDE ruling does not apply to Edison)
