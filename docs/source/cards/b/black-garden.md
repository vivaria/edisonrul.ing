...
*   The ① mandatory Trigger-like Effect CANNOT miss the timing.
    - Player A performs a Normal Summon, causing "Black Garden" to activate. Player A chooses which Zone the "Rose Token" is Summoned to, and is considered its *owner* (for "Remove Brainwashing").
