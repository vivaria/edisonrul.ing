...
> ① When this card is Special Summoned: You can target up to 2 cards on the field; destroy them.
...
*   If this card being Special Summoned was not the last thing to happen (e.g. if this card was Special Summoned at CL2 or higher), the ① effect will miss the timing.
