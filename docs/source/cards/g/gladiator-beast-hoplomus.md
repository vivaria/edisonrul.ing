...
*   The ① Continuous Effect does not activate.
    *   This effect no longer applies if Hoplomus is flipped face-down, leaves the field, or has its effects negated by “Skill Drain” (even if “Skill Drain” is later negated / destroyed).
...
Source: [https://edisonformat.net/card?name=Gladiator%20Beast%20Hoplomus](https://edisonformat.net/card?name=Gladiator%20Beast%20Hoplomus)

### Edison-Accurate PSCT

> ① If this card was Special Summoned by the effect of a "Gladiator Beast" monster, its original DEF is 2400.
> ② At the end of the Battle Phase, if this battled:
> You can shuffle it into the Deck; Special Summon 1 "Gladiator Beast" monster from your Deck (except “Gladiator Beast Hoplomus”).
