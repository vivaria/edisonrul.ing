...
*   The ① Continuous Effect does not start a chain.
    *   If "Blackwing - Gale the Whirlwind" halves this card's ATK, its ATK will not change anymore.
*   The ② Continuous Effect does not start a chain.
...
Source: [https://edisonformat.net/card?name=Gragonith,%20Lightsworn%20Dragon](https://edisonformat.net/card?name=Gragonith,%20Lightsworn%20Dragon)
