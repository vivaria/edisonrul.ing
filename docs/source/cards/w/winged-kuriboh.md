...
Source: [https://edisonformat.net/card?name=Winged%20Kuriboh](https://edisonformat.net/card?name=Winged%20Kuriboh)
...
*   If “Winged Kuriboh” is destroyed as a result of battle, its effect won't reduce the Battle Damage its owner takes from that battle, because its effect doesn’t activate until later, when it’s sent to the GY. (And damage calculation has already happened by then.)
